export const tstDEBUG = {
    quizTitle: "Heyo Debug Test",
    ...
    questions: [
        ...
        [1, 'You!', 'Nothin\'...', 'The timer :(', 'I\'m taking this quiz blindfolded']],

        [6, "6)", "What is the meaning of life?", 
        [4, 'Money', 'Coffee', '*insert user\'s personal philosophy here*', '42']],

        [7, "7)", "我是个傻男人", 
        [2, '是的', 'what?', '去湖里跳', '你妈妈']],

        [8, "8)", "How many answers are below?", 
        [1, 'Three', 'Two', 'One']],

        [9, "9)", "Whatabout now??", 
        [6, 'One', 'Two', 'Three', 'Four', 'Five', 'Six']],

        [10, "10)", "Here's a freebee for taking my quiz!", 
        [1, 'Pick Me!']],

        ['END', "You have finished the quiz!", "Submit Highscore?", [1, 'Yes', 'No']],
    ],
};